...
def Signup():
    ...
    roots.title('SignUp')
    photo = tkinter.PhotoImage(file="MangagedMonitoringConsole.gif")
...
def Path():
    ...
    def first():
        folderpath = e.get()
        foldermodification.FileWatch(str(folderpath)) # this passes the variable s to the function second() in the file twond.py
